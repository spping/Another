...
class Attention(models.Model):
    ...
    uid = models.ForeignKey('Bloger', models.DO_NOTHING, db_column='Uid', related_name = 'attenuid')  # Field name made lowercase.
    touid = models.ForeignKey('Bloger', models.DO_NOTHING, db_column='ToUid')  # Field name made lowercase.
...
class Blog(models.Model):
    ...
    uid = models.ForeignKey('Bloger', models.DO_NOTHING, db_column='Uid')  # Field name made lowercase.
...
class Bloger(models.Model):
    ...
    uname = models.CharField(db_column='Uname', unique=True, max_length=20)  # Field name made lowercase.
    upass = models.CharField(db_column='Upass', max_length=20)  # Field name made lowercase.
